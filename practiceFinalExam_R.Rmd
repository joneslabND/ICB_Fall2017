...
2\. The following R code is intended to count how many values contained in the vector x are above 10 and how many are below 10 and then print both values. Unfortunately, the code isn't working. Fix the code so that it works as intended. 
